...
app.use(
  helmet({
    ...
    contentSecurityPolicy: {
      directives: {
        defaultSrc: ["'self'"],
        imgSrc: ["'self'", "data:", "blob:", process.env.CLIENT_URL || "https://gicprojects.com.ng" || "http://localhost:3000"],
        connectSrc: ["'self'", process.env.CLIENT_URL || "https://gicprojects.com.ng" || "http://localhost:3000"],
...
const limiter = rateLimit({
  ...
  max: 4000 // limiting each IP to 4000 requests per windowMs
});
app.use('/api/', limiter);
